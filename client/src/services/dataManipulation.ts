  ...
  return deliveries.map((delivery) => {
    ...
    return {
      ...
      itemsToBeDelivered: {
        ...
        gardenGlow: delivery.gardenGlow,
        farmSalad: delivery.farmSalad,
        kebabMeal: delivery.kebabMeal,
        sundaySpecial: delivery.sundaySpecial,
        noirChoclate: delivery.noirChoclate,
        whiteDetox: delivery.whiteDetox,
      } as IItems,
